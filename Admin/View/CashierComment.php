<?php
include "../Controller/CashierCommentProcess.php";
?>
<html>  
        <head>
...
<link rel="stylesheet" type="text/css" href="../CSS/mystyle.css">
        <?php echo '<h2 align="center"><u> Cashier Comments</u></h2>'  ?>
</head>

<body>
<form action="../Controller/CashierCommentProcess.php"  method="post" enctype="multipart/form-data">
   <pre>  
