<?php
include "../Controller/ViewTransectionsProcess.php";
?>
<html>  
        <head>
        <?php echo '<h2 align="center"><u> Transections</u></h2>'  ?>
</head>

<body>
<form action="../Controller/ViewTransectionsProcess.php"  method="post" enctype="multipart/form-data">
   <pre>
