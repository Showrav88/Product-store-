<?php
include "../Controller/ManagerCommentProcess.php";
?>
<html>  
        <head>
        <link rel="stylesheet" type="text/css" href="../CSS/mystyle.css">             
        <?php echo '<h2 align="center"><u> Manager Comments</u></h2>'  ?>
</head>

<body>
<form action="../Controller/ManagerCommentProcess.php"  method="post" enctype="multipart/form-data">
   <pre>
