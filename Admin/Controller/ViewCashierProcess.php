...
if(isset($_POST['View'])){
    ...
    $mydata=$mydb->fetchData($conobj, "cashierinfo");


   
        echo '<h2 align="center"> Cashier Information</h2>';
...
if(empty($searchInfo)){
    ...
    $mydata=$mydb->searchCashier($conobj, "cashierinfo",$searchInfo);
