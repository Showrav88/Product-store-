...
if(isset($_POST['View'])){
    ...
    $mydata=$mydb->fetchData($conobj, "admininfo");


   
        echo '<h2 align="center"> Admin Information</h2>';
...
if(empty($searchInfo)){
    ...
    $mydata=$mydb->searchAdmin($conobj, "admininfo",$searchInfo);
