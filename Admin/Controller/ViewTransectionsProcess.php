...
if(isset($_POST['View'])){
    ...
    $mydata=$mydb->fetchData($conobj, "transections");


   
        echo '<h2 align="center"> Transections</h2>';
        ...
        {          while($row=$mydata->fetch_assoc())
            {
                   ...
                   echo "Id         : ".$row["id"]."</br>";
                   echo "Amount     : ".$row["amount"]." Taka"."</br>";
...
if(empty($searchInfo)){
    ...
    $mydata=$mydb->searchTransections($conobj, "transections",$searchInfo);
