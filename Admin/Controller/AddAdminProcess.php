...
$fname=$lname=$age=$gender=$contNo=$email=$pass=$conPass="";
$fnameerr=$lnameerr=$ageerr=$gendererr=$contNoerr=$emailerr=$fileerr=$passerr=$conPasserr=$dataerr="";
...
if(move_uploaded_file($_FILES["myfile"]["tmp_name"], "../Images/".$fname.$lname."Admin".date("Y-m-d").".jpg")){
    ...
    $fileerr="Please choose a jpg file!";
       ...
       if($count==9){
        ...
        $mydb=new DB();
        $conobj=$mydb->opencon();
       $dataerr= $mydb->InsertData($fname,$lname,$age, $_POST["gender"],$contNo,$email,$pass,"admininfo",$conobj);
